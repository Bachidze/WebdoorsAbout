      ...
      <main className='w-[95%] pt-[50px] max-w-[1920px] m-[auto] md:w-[90%] md:mt-[61px]'>
        <section className='flex flex-col justify-center items-center xl:mt-[100px] xl:mb-[40px]'>
            ...
            <div className='flex items-center gap-2'>
                ...
                <h2 className='hidden md:flex text-[18px] text-white leading-[22.5px] font-normal pt-[9.69px] xl:text-[32px] xl:leading-[40px] xl:mt-[14px]'>We are Webdoors</h2>
                <img className='pt-[3px] md:hidden' src="/assets/MobilePurpleServicesWebdoors.svg" alt="PurpleServices" />
            </div>
        </section>
        <section className='pt-[37.65px]  word'>
        ...
        <section className='flex flex-wrap  justify-between m-auto max-w-[1200px] pt-[50px] gap-[40px]  md:mt-[60px] maingrid xl:w-[80%] xl:max-w-[1021px] xl:gap-[60px] xl:m-auto medium'>
            ...
            <div className='flex flex-col items-center justify-center  irakli'>
                <img className='rounded-[50%] w-[115.58px] h-[115.58px] object-cover xl:w-[187.69px] xl:h-[187.69px]' src="/assets/IrakliWebdoors.svg" alt="irakli" />
            ...
            <div className='flex flex-col items-center justify-center giorgi'>
                <img className='rounded-[50%] w-[115.58px] h-[115.58px] object-cover xl:w-[187.69px] xl:h-[187.69px]' src="/assets/Giorgi.svg" alt="giorgi" />
            ...
            <div className='flex flex-col items-center justify-center daviti'>
                <img className='rounded-[50%] w-[115.58px] h-[115.58px] object-cover  xl:w-[187.69px] xl:h-[187.69px]' src="/assets/Daviti.svg" alt="Daviti" />
            ...
            <div className='flex flex-col items-center justify-center bidzina'>
                <img className='rounded-[50%] w-[115.58px] h-[115.58px] object-cover xl:w-[187.69px] xl:h-[187.69px]' src="/assets/Bidzina.svg" alt="Bidzina" />
            ...
            <div className='flex flex-col items-center justify-center dachi'>
                <img className='rounded-[50%] w-[115.58px] h-[115.58px] object-cover xl:w-[187.69px] xl:h-[187.69px]' src="/assets/Dachi.svg" alt="Dachi" />
            ...
            <div className='flex flex-col items-center justify-center ana'>
                <img className='rounded-[50%] w-[115.58px] h-[115.58px] object-cover xl:w-[187.69px] xl:h-[187.69px]' src="/assets/Ana.svg" alt="Ana" />
            ...
            <div className='flex flex-col items-center justify-center sandro'>
                <img className='rounded-[50%] w-[115.58px] h-[115.58px] object-cover xl:w-[187.69px] xl:h-[187.69px]' src="/assets/Sandro.svg" alt="Sandro" />
            ...
            <div className='flex flex-col items-center justify-center iza'>
                <img className='rounded-[50%] w-[115.58px] h-[115.58px] object-cover xl:w-[187.69px] xl:h-[187.69px]' src="/assets/Iza.svg" alt="Iza" />
